...
$user_id=null;
$sql1= "select * from person where Lutrabajo like '%$_GET[s]%' or experiencia like '%$_GET[s]%' or salario like '%$_GET[s]%' or jornada like '%$_GET[s]%' or Cargo_Categoria like '%$_GET[s]%' ";
