            ...
            <div class="modal-body">
                <form action="actualiza.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="descripcion" id="descripcion" class="form-control form-control-sm" rows="1" required></textarea>
                    </div>

                    <div class="mb-2">
                        <label for="genero" class="form-label">Vacante Que Solicita:</label>
                    ...
                    <div class="mb-3">
                        <label for="poster" class="form-label">Hoja De Vida:</label>
